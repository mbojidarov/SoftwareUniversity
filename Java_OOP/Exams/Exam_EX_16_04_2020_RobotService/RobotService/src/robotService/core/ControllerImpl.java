...
public class ControllerImpl implements Controller {
    ...
    private void checkIfRobotExist(String robotName) {
    ...
    public String manufacture(String robotType, String name, int energy, int happiness, int procedureTime) {
        Robot robot;
        if ("Cleaner".equals(robotType)){
            robot = new Cleaner(name, energy, happiness, procedureTime);

        }else if ("Housekeeper".equals(robotType)){
        ...
        garage.getRobots().put(robot.getName(), robot);
        return String.format(ROBOT_MANUFACTURED, name);  //robotType???
    }
